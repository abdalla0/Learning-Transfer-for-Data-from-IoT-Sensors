...
dev_id  = 33 	
series = read_csv('knoy_pcb_1_Y_320.csv', header=0, parse_dates=[0], index_col=0, squeeze=True, date_parser=parser)
X = series.values
size = int(len(X) * 0.67)
...
pyplot.ylabel('Vibration-Y', fontdict=None, labelpad=None)
pyplot.show()
